...
export function LampComponentCart() {
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-[446px] md:mt-[460px] bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Carrito de compras
      </motion.h1>
    </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-[400px] flex-col items-center justify-center overflow-hidden bg-neutral-950 w-full z-0',
        className
      )}
    >
