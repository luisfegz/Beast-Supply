  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-0 bg-gradient-to-br from-zinc-300 to-neutral-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-[800px] flex-col items-center justify-center overflow-hidden bg-black w-full z-0',
        className
      )}
    >
